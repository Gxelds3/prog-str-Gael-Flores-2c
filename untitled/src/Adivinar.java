...
public class Adivinar {
    public static int fueraRango = 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Veces ingresadas fuera de rango: " + fueraRango);
        System.out.println("Veces ingresadas de dato no numerico: " + noNumerico);
    }
